...
PROW_JOBS_SCRAPER_SHORT_TAG="$(git rev-parse --short=7 HEAD)"
PROW_JOBS_SCRAPER_IMAGE_COMMIT_SHORT_SHA="${PROW_JOBS_SCRAPER_IMAGE}:${PROW_JOBS_SCRAPER_SHORT_TAG}"
${CONTAINER_CMD} tag "${PROW_JOBS_SCRAPER_IMAGE_COMMIT_SHA}" "${PROW_JOBS_SCRAPER_IMAGE_COMMIT_SHORT_SHA}"
${CONTAINER_CMD} push "${PROW_JOBS_SCRAPER_IMAGE_COMMIT_SHORT_SHA}"
...
${CONTAINER_CMD} push "${PROW_JOBS_SCRAPER_IMAGE_LATEST}"
